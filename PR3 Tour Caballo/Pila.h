...
class PILA
{
   ...
   public:
            ...
            NODOI* regresaNth(int Posicion); // Regresa el apuntador al item de la posicion N-ésima o Null si no existe.
            NODOI* inicio();            // Regresa el valor del apuntador base (raiz).
            NODOI* final();             // Regresa el valor del apuntador final.
