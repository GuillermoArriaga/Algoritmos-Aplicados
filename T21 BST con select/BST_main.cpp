   ...
   BST arbol;
    ...
    { LIMPIAR
      cout<<"\n\n\n\t\tGuillermo Arriaga Garcia"
            ...
            "\n\t11.- Buscar un valor."
            "\n\t12.- SELECT regresa el k-esimo valor de los datos ordenados.";
      ...
      { default: break;
         ...
         case 12: cout<<"\n\n\tIngresa la posicion k-esima: "; 
                  cin>>k;
                  if(k>0)
                  { valor=arbol.select(k);
                    if(valor==-123456789)
                      cout<<"\n\n\tTal posicion no es posible.";
                    else 
                      cout<<"\n\n\tEl valor "<<k<<"a de los datos ordenados es "
                          <<valor;
                    PAUSA
                  }
                  break;            
